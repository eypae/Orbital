...
{
    private GameObject[] patrolPoints; //array to store all the patrol points for boss to walk to
    ...
    override public void OnStateEnter(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        randomPoint = Random.Range(0, patrolPoints.Length); //selecting a randomPoint for boss to walk to
    }
